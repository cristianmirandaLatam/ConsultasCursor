...
Proporcionado por Alliance for Qualification, Artificial Intelligence United, Chinese Software Testing Qualifications Board y Korean Software Testing Qualifications Board

---

## Aviso de Derechos de Autor

Copyright Notice © International Software Testing Qualifications Board (en adelante ISTQB®)

ISTQB® es una marca registrada del International Software Testing Qualifications Board.

Copyright © 2026, los autores Klaudia Dussa-Zieger (presidenta), Stuart Reid, Vipul Kocher, Qin Liu, Jarosław Hryszko, Kyle Alexander Siemens y Werner Henschelchen.

Copyright © 2021, los autores Klaudia Dussa-Zieger (presidenta), Vipul Kocher, Qin Liu, Stuart Reid, Kyle Alexander Siemens, Werner Henschelchen y Adam Leon Smith.

Todos los derechos reservados. Los autores transfieren por la presente los derechos de autor al ISTQB®. Los autores (como titulares actuales de los derechos de autor) y el ISTQB® (como futuro titular de los derechos de autor) han acordado las siguientes condiciones de uso:

- Se pueden copiar extractos, para uso no comercial, de este documento si se reconoce la fuente. Cualquier Proveedor de Formación Acreditado puede utilizar este syllabus como base para un curso de formación si se reconoce a los autores y al ISTQB® como fuente y propietarios de los derechos de autor del syllabus, y siempre que cualquier publicidad de dicho curso de formación solo pueda mencionar el syllabus después de que la Acreditación oficial de los materiales de formación haya sido recibida de un Consejo Miembro reconocido por el ISTQB®.
- Cualquier individuo o grupo de individuos puede utilizar este syllabus como base para artículos y libros, si se reconoce a los autores y al ISTQB® como fuente y propietarios de los derechos de autor del syllabus.
- Cualquier otro uso de este syllabus está prohibido sin obtener primero la aprobación por escrito del ISTQB®.
- Cualquier Consejo Miembro reconocido por el ISTQB® puede traducir este syllabus, siempre que reproduzca el Aviso de Derechos de Autor mencionado anteriormente en la versión traducida del syllabus.
...
|---------|-------|---------------|
| 1.0 | 2021/10/01 | Publicación para GA |
| 2.0 Alpha | 2025/08/15 | Revisión Alpha |
| 2.0 Beta | 2026/01/07 | Revisión Beta |
| 2.0 | 2026/04/17 | Publicación para GA |
...
## Agradecimientos
La Asamblea General del ISTQB® publicó formalmente este documento el 17 de abril de 2026.

---

## 0 Introducción

### 0.1 Propósito de este Syllabus
Este syllabus constituye la base para el ISTQB® Certified Tester AI Testing. El ISTQB® proporciona este syllabus de la siguiente manera:
- A los consejos miembros, para su traducción al idioma local y para la acreditación de proveedores de formación. Los consejos miembros pueden adaptar el syllabus a las necesidades específicas de su idioma y modificar las referencias para alinearlas con sus publicaciones locales.
- A los organismos de certificación, para elaborar preguntas de examen en su idioma local, adaptadas a los objetivos de aprendizaje de este syllabus.
- A los proveedores de formación, para producir material didáctico y determinar los métodos de enseñanza apropiados.
- A los candidatos a la certificación, para prepararse para el examen de certificación (ya sea como parte de un curso de formación o de forma independiente).
- A la comunidad internacional de ingeniería de software y sistemas, para avanzar en la profesión de pruebas de software y sistemas, y como base para libros y artículos.

### 0.2 El Certified Tester AI Testing
El Certified Tester AI Testing (CT-AI) está diseñado para personas involucradas en las pruebas de sistemas basados en AI. Esto incluye personas en diversos roles, como testers, analistas de pruebas, analistas de datos, ingenieros de pruebas, consultores de pruebas, gestores de pruebas, testers de aceptación de usuario y desarrolladores de software. Esta certificación también es adecuada para personas que buscan una comprensión fundamental de las pruebas de sistemas basados en AI, incluyendo gestores de proyecto, gestores de calidad, gestores de desarrollo de software, analistas de negocio, miembros de equipos de operaciones, directores de TI y consultores de gestión.

### 0.3 Trayectoria Profesional para Testers
El esquema del ISTQB® proporciona apoyo a los profesionales de pruebas en todas las etapas de sus carreras. Las personas que obtienen la certificación ISTQB® Certified Tester Foundation Level también pueden estar interesadas en los Niveles Avanzados Básicos (Test Analyst, Technical Test Analyst y Test Manager) y, posteriormente, en el Nivel Experto (Test Management o Improving the Test Process). La línea de Especialista ofrece una inmersión profunda en enfoques y actividades de prueba específicos, por ejemplo, Agile Testing, Test Automation, AI Testing, Testing with Generative AI o Mobile App Testing, o en conocimientos de pruebas grupales para determinados dominios industriales, por ejemplo, Automotive o Gaming. Visite www.istqb.org para obtener la información más reciente sobre el esquema Certified Tester del ISTQB.

### 0.4 Resultados de Negocio
Esta sección enumera los Resultados de Negocio esperados de un candidato que haya obtenido la certificación CT-AI.

Un Certified Tester en AI Testing puede:
BO1 Comprender el estado actual de la AI, incluyendo la AI generativa.
BO2 Experimentar la implementación y las pruebas de modelos de machine learning.
BO3 Comprender el funcionamiento y las pruebas de redes neuronales simples.
BO4 Comprender las características de calidad específicas de AI definidas por ISO/IEC 25059.
BO5 Calcular e interpretar métricas de rendimiento funcional de ML para modelos de machine learning.
BO6 Reconocer el alcance y la importancia de los dos niveles de prueba específicos para las pruebas de sistemas de machine learning.
BO7 Contribuir al desarrollo de una estrategia de pruebas efectiva para un sistema de machine learning.
BO8 Diseñar y ejecutar casos de prueba para sistemas de machine learning.

### 0.5 Objetivos de Aprendizaje, Objetivos Prácticos y Nivel Cognitivo de Conocimiento
Los Objetivos de Aprendizaje (LO) respaldan los resultados de negocio y se utilizan para crear los exámenes CT-AI. Los niveles específicos de los objetivos de aprendizaje se muestran al inicio de cada capítulo y se clasifican de la siguiente manera:
- K1: Recordar
- K2: Comprender
- K3: Aplicar
- K4: Analizar

Se proporcionan más detalles y ejemplos de objetivos de aprendizaje en el Apéndice A.

Para todos los términos enumerados como palabras clave justo debajo de los encabezados de los capítulos, se deberá recordar (K1) el nombre correcto y la definición del Glosario del ISTQB® o del Capítulo 9, incluso si no se mencionan explícitamente en el objetivo de aprendizaje.

Los Objetivos Prácticos (HO) se centran en la aplicación práctica de los Objetivos de Aprendizaje y se muestran al inicio de cada capítulo. El nivel de un HO se clasifica de la siguiente manera:
- H0: Puede incluir una demostración en vivo de un ejercicio o un vídeo grabado. Dado que el alumno no lo realiza, no es estrictamente un ejercicio.
- H1: Ejercicio guiado. Los alumnos siguen una secuencia de pasos realizados por el formador.
- H2: Ejercicio con pistas. Al alumno se le proporciona un ejercicio con pistas relevantes para permitir que el ejercicio se resuelva dentro del plazo establecido.

### 0.6 El Examen del Certificado Certified Tester AI Testing
El examen CT-AI se basará en los Objetivos de Aprendizaje descritos en este syllabus. Todas las secciones del syllabus son evaluables excepto la Introducción, los Objetivos Prácticos, las Referencias y los Apéndices. Responder a las preguntas del examen puede requerir el uso de material basado en más de una sección de este syllabus. Los estándares y libros se incluyen como referencias, pero su contenido no es evaluable más allá de lo resumido en el propio syllabus.

Consulte el documento de Estructuras y Reglas de Examen para el CT-AI v2.0 para más detalles.

El criterio de entrada principal para cualquier persona interesada en realizar el examen CT-AI es poseer el certificado ISTQB® Certified Tester Foundation Level [CTFL].

Se recomienda encarecidamente que los candidatos también:
- Tengan una experiencia mínima en desarrollo de software o en pruebas de software, como seis meses de experiencia como tester de sistema o de aceptación de usuario, científico de datos o desarrollador de software.
- Realicen un curso acreditado según los estándares del ISTQB® (por uno de los consejos miembros reconocidos por el ISTQB).

### 0.7 Acreditación
Un Consejo Miembro del ISTQB® puede acreditar a proveedores de formación cuyo material de curso siga este syllabus. Los proveedores de formación deben obtener las directrices de acreditación del Consejo Miembro o del organismo que realiza la acreditación. Un curso acreditado se reconoce como conforme a este syllabus y permite que un examen del ISTQB® se incluya en el curso.

Las directrices de acreditación para este syllabus siguen las Directrices Generales de Acreditación publicadas por el Processes Management and Compliance Working Group.

### 0.8 Tratamiento de Estándares
Las organizaciones internacionales de estandarización como IEEE e ISO han emitido estándares asociados con las características de calidad y las pruebas de software. El propósito de estas referencias es proporcionar un marco (como en las referencias a ISO/IEC 25059 e ISO/IEC 25010 respecto a un modelo de calidad para sistemas basados en AI) o proporcionar una fuente de información adicional si el lector lo desea. Tenga en cuenta que los syllabus utilizan los documentos de estándares como referencia. Los documentos de estándares no están destinados a ser evaluados en el examen.

### 0.9 Nivel de Detalle
El nivel de detalle en este syllabus permite cursos y exámenes internacionalmente consistentes. Para lograr este objetivo, el syllabus consta de:
- Objetivos instructivos generales que describen la intención del syllabus CT-AI
- Una lista de palabras clave que los estudiantes deben ser capaces de recordar
- Objetivos de aprendizaje para cada área de conocimiento, que describen el resultado de aprendizaje cognitivo a alcanzar
- Una descripción de los conceptos clave, incluyendo referencias a fuentes como literatura aceptada o estándares

El contenido del syllabus no describe toda el área de conocimiento de las pruebas de software; refleja el nivel de detalle que debe cubrirse en los cursos de formación CT-AI. Se centra en introducir los conceptos básicos de la AI y del machine learning (ML) en particular, y cómo pueden probarse los sistemas basados en estas tecnologías.

El syllabus utiliza la terminología (es decir, el nombre y significado) de los términos utilizados en las pruebas de software y el aseguramiento de la calidad según el Glosario del ISTQB®.

### 0.10 Cómo está Organizado este Syllabus
Hay siete capítulos con contenido evaluable. El encabezado de nivel superior de cada capítulo especifica la duración del capítulo; no se proporciona una temporización a nivel de capítulo. Para los cursos de formación acreditados, el syllabus requiere un mínimo de 19,5 horas de instrucción, distribuidas en los siete capítulos de la siguiente manera:

- Capítulo 1: 120 minutos – Introducción a la Inteligencia Artificial (AI)
  - Comprender las diferencias clave entre los sistemas basados en AI y los sistemas convencionales, y explorar el espectro de capacidades de la AI, que abarca desde la AI estrecha hasta la super AI.
  - Obtener una comprensión fundamental de las tecnologías de AI, incluyendo la AI generativa (GenAI), y el hardware, el alojamiento y los marcos de desarrollo utilizados para implementar sistemas de machine learning (MLS).
  - Aprender cómo las regulaciones y los estándares influyen en el desarrollo y las pruebas de soluciones basadas en AI.

- Capítulo 2: 45 minutos – Características de Calidad para Sistemas Basados en AI
  - Aprender sobre las características de calidad específicas de los sistemas basados en AI, incluyendo las definidas en ISO/IEC 25059, y comprender las consideraciones de seguridad al utilizar AI en sistemas críticos.
  - Explorar cómo definir criterios de aceptación apropiados adaptados al comportamiento y rendimiento únicos de las soluciones basadas en AI.

- Capítulo 3: 375 minutos – Machine Learning
  - Comprender los tipos de ML, los pasos clave en el flujo de trabajo de desarrollo de ML, y cómo los modelos preentrenados, el ajuste fino y la generación aumentada por recuperación contribuyen a los sistemas modernos basados en AI.
  - Aprender sobre la preparación de datos, los roles de los conjuntos de datos de entrenamiento, validación y prueba, y cómo estos influyen en el desarrollo y rendimiento del modelo de ML.
  - Explorar las redes neuronales, incluyendo su estructura y medidas de cobertura, y obtener experiencia práctica con métricas de rendimiento y el uso de una matriz de confusión.

- Capítulo 4: 195 minutos – Pruebas de Sistemas Basados en AI
  - Comprender los desafíos únicos de las pruebas de sistemas basados en AI, incluyendo las diferencias en la testabilidad entre sistemas bloqueados y adaptativos, la necesidad de pruebas estadísticas y las dificultades de definir oráculos de prueba.
  - Aprender a probar GenAI y modelos de lenguaje de gran escala (LLM), utilizando técnicas como red teaming y pruebas exploratorias para AI que realizan tareas de prueba.
  - Explorar estrategias de prueba para MLS, cubriendo diversos niveles de prueba y la aplicación de pruebas basadas en riesgos.

- Capítulo 5: 180 minutos – Pruebas de Datos de Entrada para Sistemas de Machine Learning
  - Aprender a probar y validar los datos de entrada para MLS, incluyendo técnicas para detectar sesgos, verificar la corrección del etiquetado, evaluar la representatividad de los datos y probar el pipeline de datos.

- Capítulo 6: 225 minutos – Pruebas de Modelos para Sistemas de Machine Learning
  - Descubrir enfoques de prueba para mitigar riesgos en modelos de ML, incluyendo revisiones de documentación, pruebas de rendimiento funcional de ML y detección de sobreajuste, subajuste y deriva.
  - Aprender enfoques de prueba avanzados, incluyendo pruebas adversariales, pruebas A/B, pruebas comparativas back-to-back y el uso de ataques para descubrir debilidades del modelo.
  - Obtener comprensión práctica de las pruebas metamórficas, incluyendo cómo derivar y aplicar casos de prueba donde los oráculos de prueba tradicionales son insuficientes.

- Capítulo 7: 30 minutos – Pruebas de Desarrollo de Machine Learning
  - Aprender enfoques y estrategias de prueba para mitigar riesgos durante el desarrollo y despliegue de MLS, para respaldar un comportamiento robusto del sistema en entornos de producción.

---

## 1 Introducción a la Inteligencia Artificial – 120 minutos

**Palabras clave:** Ninguna

**Palabras clave específicas de AI:** sistema basado en AI, inteligencia artificial, AI general, machine learning, ML development framework, AI estrecha, super AI

**Objetivos de Aprendizaje para el Capítulo 1:**

1.1 Introducción a la AI
- AI-1.1.1 (K2) Diferenciar entre sistemas basados en AI y sistemas convencionales
- AI-1.1.2 (K2) Distinguir entre AI estrecha, AI general y super AI
- AI-1.1.3 (K2) Explicar los diferentes tipos de tecnologías de AI
- AI-1.1.4 (K2) Explicar la AI generativa
- AI-1.1.5 (K2) Comparar las opciones disponibles de hardware para implementar sistemas de machine learning
- AI-1.1.6 (K2) Comparar las opciones para el desarrollo y alojamiento de modelos de AI
- AI-1.1.7 (K2) Resumir la funcionalidad proporcionada por los ML development frameworks
- AI-1.1.8 (K2) Explicar cómo las regulaciones y los estándares afectan al desarrollo y las pruebas de sistemas basados en AI

### 1.1 Introducción a la AI
Este capítulo presenta las distinciones clave entre los sistemas convencionales y los basados en AI, centrándose en sus enfoques de diseño, adaptabilidad y explicabilidad. Describe el espectro de capacidades de la AI, que abarca desde la AI estrecha hasta la AI general y la super AI, y describe las tecnologías fundamentales como el ML, el aprendizaje profundo y la GenAI. El capítulo describe el hardware común y los entornos de desarrollo para sistemas basados en AI, así como los frameworks de ML más populares. Finalmente, considera las regulaciones esenciales y los estándares técnicos que guían el desarrollo y despliegue responsable de la AI en diversos dominios.

#### 1.1.1 Sistemas Basados en AI y Sistemas Convencionales
Los sistemas informáticos convencionales se programan típicamente utilizando lenguajes imperativos, donde los desarrolladores humanos definen explícitamente instrucciones paso a paso, incluyendo construcciones como sentencias if-then-else y bucles. Este enfoque determinista ayuda a que el comportamiento del sistema sea predecible y transparente, facilitando a los humanos la comprensión de cómo las entradas producen diferentes salidas. En contraste, la mayoría de los sistemas basados en AI, particularmente aquellos que utilizan ML, no siguen reglas predefinidas. En su lugar, analizan patrones en los datos para determinar cómo responder a nuevas entradas. Por ejemplo, un sistema de reconocimiento de imágenes basado en AI entrenado para identificar gatos no se basa en reglas codificadas explícitamente. En su lugar, aprende de un conjunto de datos de imágenes de gatos, extrayendo patrones que luego aplica a imágenes no vistas para clasificarlas con precisión.

Una diferencia fundamental entre los sistemas convencionales y los basados en AI es cómo abordan la resolución de problemas. Muchos sistemas basados en AI se basan en razonamiento probabilístico, inferencia estadística y reconocimiento de patrones para generar resultados. Esto permite que los modelos de AI manejen formas complejas de incertidumbre y ambigüedad de manera más efectiva, lo que resulta en salidas que no siempre son predecibles.

Un desafío clave en los sistemas basados en AI es la explicabilidad. Muchos modelos de AI, particularmente las arquitecturas de aprendizaje profundo, pueden contener miles de millones de parámetros, lo que hace que su funcionamiento interno sea difícil de interpretar para los humanos. Esta naturaleza de "caja negra" genera preocupaciones en dominios críticos como la salud, las finanzas, la defensa y el transporte, donde comprender por qué un modelo de AI tomó una decisión particular es crucial. Lograr transparencia (véase 2.1.1) y explicabilidad en la toma de decisiones impulsada por AI se ha convertido en un enfoque crítico en la regulación de la AI.

Otra distinción significativa es la adaptabilidad. Los sistemas convencionales son estáticos y típicamente requieren actualizaciones manuales para incorporar nuevo conocimiento o responder a cambios en el entorno. Los sistemas basados en AI, en contraste, pueden ser autoajustables, mejorando continuamente su rendimiento a medida que encuentran nuevos datos. Esta adaptabilidad hace que la AI sea particularmente poderosa en entornos dinámicos. La adaptabilidad también requiere monitorización continua para mantener la alineación permanente con los requisitos fundamentales.

#### 1.1.2 AI Estrecha, AI General y Super AI
La AI estrecha, también conocida como AI débil, está diseñada para realizar tareas específicas y representa todos los sistemas de AI desplegados en uso actualmente. Los sistemas basados en AI estrecha operan dentro de un dominio limitado y pueden ser altamente eficientes en la resolución de problemas especializados, como el reconocimiento de imágenes, el procesamiento del habla y la traducción de idiomas. Sin embargo, carecen de la capacidad de generalizar más allá de las funciones que han aprendido. Por ejemplo, un sistema basado en AI que destaca en el reconocimiento de rostros no puede realizar traducción de idiomas a menos que sea reentrenado explícitamente para hacerlo. La AI de frontera, un subconjunto de la AI estrecha, representa la forma más avanzada de estos sistemas, empujando los límites de las capacidades actuales con modelos de GenAI. La AI de frontera incluye sistemas a gran escala con capacidades de toma de decisiones altamente autónomas; sin embargo, siguen siendo específicos para tareas y aún no han alcanzado la versatilidad de la AI general.

La AI general, también conocida como AI fuerte, se refiere a un sistema basado en AI que posee la capacidad de realizar la mayoría de las tareas intelectuales que un humano puede realizar. La AI general sería capaz de comprender, aprender y aplicar conocimiento en una amplia gama de tareas sin necesidad de ser reentrenada para cada nueva tarea. Este tipo de AI exhibiría razonamiento y adaptabilidad similares a los humanos, capaz de resolver problemas desconocidos en diversos dominios, de manera muy similar a como lo hacen los humanos. A pesar del progreso significativo en AI, ningún sistema basado en AI posee actualmente inteligencia general.

La super AI (superinteligencia artificial) es la forma de AI en la que un sistema basado en AI mejora continuamente por sí mismo sin necesidad de intervención o control humano. Para que la super AI sea posible, el acceso a Internet no es estrictamente necesario, pero dicho acceso podría expandir significativamente sus capacidades e influencia. Superaría a la inteligencia humana y a la AI general, lo que muchos creen que representaría un riesgo existencial para la humanidad. El punto en el que los sistemas basados en AI transicionarían de la AI general a la super AI, si llegara a ocurrir, se conoce comúnmente como la singularidad tecnológica.

#### 1.1.3 Diferentes Tipos de Tecnologías de AI
La Inteligencia Artificial abarca una gama de tecnologías, cada una adaptada a tareas y desafíos específicos. Una de las ramas fundamentales de la AI es el ML, que permite a los sistemas aprender de los datos y construir modelos sin programación explícita. Mientras que algunos MLS pueden adaptarse y mejorar continuamente con nuevos datos a lo largo de su vida útil, otros operan con el conocimiento que aprendieron inicialmente y requieren reentrenamiento explícito para actualizar sus capacidades. El ML incluye varios enfoques:
- El aprendizaje supervisado utiliza datos etiquetados y algoritmos, como la regresión lineal y los árboles de decisión, para tareas como la predicción y la clasificación.
- El aprendizaje no supervisado descubre patrones en datos no etiquetados mediante técnicas como el clustering (utilizando algoritmos de clustering).
- El aprendizaje por refuerzo permite a los agentes inteligentes aprender comportamientos óptimos a través de interacciones de prueba y error con su entorno.

Las tecnologías clave de ML incluyen redes neuronales, modelos bayesianos, máquinas de vectores de soporte (SVM) y bosques aleatorios. Véase el Capítulo 3 para más información sobre ML.

El Aprendizaje Profundo (DL), un subconjunto de los métodos de ML, utiliza redes neuronales profundas para resolver problemas complejos. Por ejemplo:
- Las redes neuronales convolucionales (CNN) son altamente efectivas para el reconocimiento de imágenes y la detección de objetos.
- Las redes neuronales recurrentes (RNN) se especializan en el procesamiento de datos secuenciales, como texto o series temporales.
- Los transformers manejan dependencias de largo alcance en secuencias, potenciando modelos para el procesamiento del lenguaje natural y vision transformers para imágenes.

La GenAI se basa en estas tecnologías para crear nuevo contenido, incluyendo texto, imágenes y audio (véase 1.1.4). Esto es impulsado por modelos como los LLM, que combinan redes neuronales profundas (DNN) con procesamiento del lenguaje natural (NLP) para analizar y generar lenguaje similar al humano.

Otras tecnologías de AI especializadas incluyen:
- NLP para el análisis del lenguaje, incluyendo tareas como el análisis de sentimiento y la traducción automática.
- Visión por computador para el análisis de datos visuales, apoyando aplicaciones como el reconocimiento facial y la robótica.
- Lógica difusa para el razonamiento bajo incertidumbre.
- Algoritmos de búsqueda para resolver problemas de optimización, como la navegación, y la toma de decisiones estratégicas.
- Sistemas de razonamiento basados en reglas, o sistemas expertos, para el soporte estructurado de decisiones.

Aunque la integración completa de estas tecnologías de AI sigue siendo limitada, nuevos desarrollos como los LLM demuestran el potencial de combinar diferentes tecnologías de AI en sistemas inteligentes unificados. La AI agéntica extiende estas tecnologías a través de agentes autónomos que planifican, razonan y actúan de forma independiente para alcanzar objetivos en entornos dinámicos.

#### 1.1.4 AI Generativa
La AI Generativa (GenAI) se refiere a sistemas basados en AI especializados en la creación de nuevo contenido, como texto, imágenes, vídeo, música o datos complejos, mientras que muchos también admiten clasificación y predicción. Estos sistemas aprenden de grandes cantidades de datos para producir salidas que se asemejan a sus datos de entrenamiento, habilitando una amplia gama de aplicaciones creativas y prácticas.

Las principales tecnologías detrás de la GenAI incluyen las redes generativas adversariales (GANs), los modelos de difusión y los transformers. Las GANs utilizan dos redes neuronales en competencia para crear datos sintéticos altamente realistas. Los modelos de difusión generan contenido añadiendo gradualmente ruido a los datos y luego eliminándolo, produciendo salidas de alta calidad. Los modelos transformer, que sustentan los LLM, utilizan mecanismos de autoatención para generar texto coherente y contextualmente relevante, y se están adaptando cada vez más para tareas multimodales.

Más allá de sus fundamentos técnicos, los sistemas de GenAI plantean preocupaciones sociales y éticas significativas. El uso indebido es una preocupación importante: estos modelos pueden ser explotados para crear deepfakes, difundir desinformación o generar contenido fraudulento convincente, socavando así la confianza en los medios digitales y el discurso público. La facilidad de producir contenido sintético amplifica los riesgos relacionados con la privacidad, la seguridad y la manipulación, pero puede aportar beneficios notables y abre oportunidades de innovación en entretenimiento, marketing, educación e investigación.

El impacto en el empleo también es notable, particularmente entre las profesiones de cuello blanco. A medida que la GenAI automatiza tareas como la escritura, el diseño, la programación e incluso la documentación legal o médica, existe un debate creciente sobre el posible desplazamiento laboral. Si bien estas tecnologías pueden aumentar la productividad y fomentar nuevas oportunidades creativas, también pueden provocar disrupciones en la fuerza laboral y requerir una recualificación generalizada.

La sostenibilidad es otra cuestión apremiante. El entrenamiento y la ejecución de grandes modelos de GenAI implican recursos computacionales sustanciales, lo que resulta en un alto consumo de energía y una huella de carbono significativa. Este impacto ambiental ha provocado llamados a diseños de modelos más eficientes e infraestructuras más ecológicas.

La mayoría de las herramientas prácticas de GenAI actuales se basan en modelos fundacionales, que luego se ajustan finamente para aplicaciones específicas. El campo también avanza hacia modelos multimodales capaces de procesar y generar contenido en texto, imágenes y audio, habilitando sistemas basados en AI más ricos y flexibles. Marcos regulatorios, como el EU AI Act [EU AI Act], están emergiendo para guiar el desarrollo y uso responsable de estas tecnologías.

#### 1.1.5 Hardware para Sistemas de Machine Learning
Se utiliza una variedad de hardware para los MLS. Diferentes tipos de hardware pueden usarse para el entrenamiento y la inferencia. Por ejemplo, un modelo de reconocimiento de voz puede ejecutarse en un smartphone de gama baja, aunque puede necesitarse acceso a la potencia de la computación en la nube para entrenarlo.

El ML típicamente se beneficia de hardware que admita lo siguiente:
- La capacidad de trabajar con grandes estructuras de datos.
- Procesamiento masivamente paralelo (concurrente), por ejemplo, para soportar la multiplicación de matrices.
- Aritmética de baja precisión (cuantización): Este enfoque utiliza menos bits para el cálculo (por ejemplo, 4 bits en lugar de 32 bits), lo que resulta en un procesamiento más rápido, menor consumo de energía, chips más pequeños y económicos, y requisitos de ancho de banda reducidos.

Las unidades centrales de procesamiento (CPU) de propósito general proporcionan soporte para operaciones complejas con alta precisión que no son típicamente requeridas para aplicaciones de ML, pero normalmente proporcionan solo unos pocos núcleos. Como resultado, su arquitectura es menos eficiente para entrenar y ejecutar modelos de ML en comparación con las unidades de procesamiento gráfico (GPU), que tienen miles de núcleos y están diseñadas para realizar procesamiento gráfico masivamente paralelo, aunque relativamente simple. En consecuencia, las GPU típicamente superan a las CPU en aplicaciones de ML, aunque las CPU generalmente funcionan a velocidades de reloj más altas. Para trabajos de ML a pequeña escala, las GPU generalmente ofrecen la mejor opción.

Algún hardware está diseñado específicamente para AI, como los Circuitos Integrados de Aplicación Específica (ASIC) construidos a propósito y los dispositivos System-on-a-Chip. Estas soluciones específicas para AI cuentan con múltiples núcleos, gestión de datos especializada y la capacidad de realizar procesamiento en memoria. Son más adecuados para la computación en el borde (edge computing), mientras que el entrenamiento del modelo de ML se realiza en la nube utilizando hardware especializado.

Las arquitecturas de hardware específicas para AI continúan desarrollándose. Esto incluye los procesadores neuromórficos, que no utilizan la arquitectura tradicional de von Neumann, sino diseños inspirados en el cerebro que imitan las estructuras neuronales.

#### 1.1.6 Desarrollo y Alojamiento de Modelos de AI
Los sistemas basados en AI pueden adquirirse de proveedores externos o desarrollarse de forma privada dentro de una organización. Los sistemas basados en AI típicamente dependen de modelos preentrenados y pueden desplegarse en las instalaciones (on-premises) o en la nube, con los modelos alojados ya sea en las instalaciones o en la nube, donde las opciones basadas en la nube a menudo se acceden como servicio (AIaaS). Los sistemas basados en AI de terceros típicamente vienen como modelos preentrenados o AI como Servicio (AIaaS), permitiendo un despliegue más rápido y un menor tiempo de comercialización. Alternativamente, los sistemas basados en AI privados (on-premises o configuraciones personalizadas en la nube) pueden adaptarse mejor a requisitos específicos, pero su desarrollo probablemente requerirá habilidades especializadas, ya sea a través de expertos internos o equipos subcontratados.

El desarrollo local (codificación y entrenamiento local) permite un control directo y privacidad. Los modelos pequeños, como árboles de decisión o redes neuronales compactas, pueden desarrollarse en computadoras personales, mientras que los modelos de tamaño medio pueden requerir GPU dedicadas. Para modelos a gran escala, se necesitan clústeres de servidores de alto rendimiento on-premises con sus costos asociados de energía, refrigeración y hardware.

El desarrollo en la nube ofrece una flexibilidad significativa. Las nubes públicas, en particular, proporcionan entornos preconfigurados con precios de pago por uso, lo que limita la inversión inicial en hardware y escala fácilmente. En contraste, las nubes privadas pueden proporcionar mayor seguridad y privacidad para las aplicaciones que lo requieran, pero este control exige una mayor inversión inicial en infraestructura.

Muchas organizaciones adoptan enfoques híbridos, incluyendo el desarrollo de prototipos localmente antes de escalar a infraestructura en la nube, manteniendo componentes sensibles on-premises, como la preparación de datos privados, y aprovechando recursos en la nube para tareas de computación intensiva.

Los modelos de AI pueden alojarse en diversos entornos, que van desde configuraciones locales hasta plataformas basadas en la nube. El alojamiento local implica ejecutar modelos más pequeños en computadoras personales o smartphones, ofreciendo privacidad y eliminando costos de licencias en la nube, aunque esto proporciona capacidades de hardware limitadas. Para modelos de AI más grandes, las organizaciones pueden establecer servidores dedicados, que requieren una inversión inicial significativa pero proporcionan un mayor control.

El alojamiento en la nube de modelos de AI puede ser en nubes públicas o privadas. Los servicios de nube pública proporcionan acceso escalable a infraestructura robusta y potente, eliminando preocupaciones de mantenimiento y siendo ideales para cargas de trabajo fluctuantes. Las nubes privadas ofrecen beneficios similares, con mayor seguridad y opciones de personalización, y son gestionadas internamente o a través de proveedores dedicados, aunque a un mayor costo.

Los enfoques híbridos combinan estos métodos, permitiendo a las organizaciones ejecutar algunas operaciones localmente mientras aprovechan la elasticidad de la nube para tareas intensivas.

Las soluciones óptimas de desarrollo y alojamiento, que típicamente se deciden por separado, dependen de factores como el tamaño del modelo, la complejidad, los requisitos de rendimiento, las restricciones presupuestarias, las consideraciones de seguridad y privacidad de datos, las necesidades de despliegue y los requisitos regulatorios. Algunas organizaciones adoptan estrategias multinivel para equilibrar eficiencia y control.

#### 1.1.7 Frameworks de Desarrollo de Machine Learning
Los ML development frameworks proporcionan un conjunto de herramientas para construir y entrenar modelos de ML. La funcionalidad típica proporcionada por estos frameworks incluye:
- Manejo de datos: Ayudan con la carga, preprocesamiento y gestión de los datos utilizados para entrenar y probar el modelo. Esto puede incluir la limpieza, el formateo y la transformación de los datos a un formato adecuado para el modelo elegido.
- Construcción de modelos: Estos frameworks ofrecen bibliotecas de algoritmos de ML y herramientas para diseñar la arquitectura del modelo de ML construido. Esto incluye especificar el tipo de modelo (por ejemplo, red neuronal, árbol de decisión), el número de capas y conexiones, y las operaciones matemáticas realizadas dentro del modelo.
- Entrenamiento y optimización: Los frameworks proporcionan algoritmos que ajustan iterativamente los parámetros internos del modelo basándose en los datos de entrenamiento y en el resultado deseado. El objetivo es optimizar el rendimiento del modelo en la realización de la tarea deseada (por ejemplo, clasificación, regresión ML). Algunos frameworks pueden soportar entrenamiento distribuido y mejorar o ajustar finamente modelos preentrenados.
- Evaluación: Ofrecen herramientas para evaluar qué tan bien se desempeña el modelo entrenado con datos no vistos. Esto puede incluir la medición de la exactitud, la precisión y la exhaustividad para tareas de clasificación, o tasas de error para tareas de regresión ML (véase 3.1.1).
- Despliegue: Algunos frameworks proporcionan capacidades para desplegar el modelo entrenado para su uso en el mundo real. Esto podría incluir la conversión del modelo a un formato adecuado para la integración con aplicaciones web, dispositivos móviles, dispositivos de borde o sistemas embebidos.

Estos frameworks pueden operar a diferentes niveles de abstracción. Algunos ofrecen una interfaz de programación de aplicaciones (API) de bajo nivel, proporcionando a los desarrolladores más control sobre la construcción del modelo pero requiriendo más experiencia en codificación. Otros ofrecen una API de alto nivel, simplificando la creación del modelo pero ofreciendo menos opciones de personalización.

Diferentes frameworks pueden centrarse en diferentes dominios de aplicación. Algunos son de propósito general y admiten una amplia gama de áreas de aplicación. En contraste, otros son más especializados, centrándose en áreas específicas como el reconocimiento de imágenes, el reconocimiento de voz y la traducción de idiomas.

La selección del framework más apropiado puede depender de varios factores, como:
- el área de aplicación;
- la necesidad de una interfaz fácil de usar para la creación rápida de prototipos;
- la configurabilidad para modelos complejos;
- la experiencia de los usuarios;
- consideraciones de despliegue, ya que algunos frameworks son más adecuados para entornos con recursos limitados;
- nivel de soporte (de la comunidad);
- madurez del ecosistema.

#### 1.1.8 Regulaciones y Estándares para AI
Las regulaciones y estándares de AI son cruciales para el desarrollo, despliegue y uso responsable de la AI. El objetivo principal es fomentar la confianza en la AI y ayudar a promover la realización de los beneficios de la AI mientras se mitigan los posibles daños. Idealmente, el cumplimiento de dichas regulaciones y estándares debería garantizar que los sistemas basados en AI sean seguros, justos, transparentes, sostenibles, responsables, éticos y utilizados de manera responsable.

A nivel internacional, los OECD AI Principles [OECD AI] y el informe de la ONU sobre Governing AI for Humanity [UN Gov AI] sirven como instrumentos influyentes de derecho indicativo (soft law) que fomentan una comprensión compartida de la gestión responsable de la AI. Actúan como una brújula para los gobiernos nacionales y las organizaciones mientras formulan sus propias estrategias de AI. Estos principios enfatizan una AI centrada en el ser humano, consideraciones éticas y la importancia de la cooperación internacional.

El EU AI Act representa un hito regulatorio, demostrando un enfoque basado en riesgos para la regulación de la AI. Al categorizar los sistemas basados en AI por riesgo, desde mínimo hasta inaceptable, las regulaciones se adaptan en consecuencia. Los sistemas de alto riesgo, particularmente aquellos que impactan en los derechos fundamentales o la seguridad, enfrentan requisitos estrictos que abarcan pruebas rigurosas, gobernanza de datos y supervisión humana. Las sanciones financieras sustanciales por incumplimiento, basadas en un porcentaje de la facturación global, subrayan el compromiso de la UE con la aplicación de la ley. En contraste, muchas naciones fuera de la UE están adoptando un enfoque más permisivo, favoreciendo regulaciones menos restrictivas para fomentar la innovación.

Los estándares técnicos, desarrollados por organizaciones como ISO e IEEE, son cruciales para traducir las aspiraciones de alto nivel en implementaciones prácticas. Proporcionan especificaciones técnicas concretas y mejores prácticas, cerrando la brecha entre la política y la práctica. Por ejemplo, ISO/IEC TR 29119-11 proporciona orientación detallada sobre las pruebas de sistemas basados en AI, un elemento crítico para demostrar el cumplimiento regulatorio. Mientras tanto, la serie ISO/IEC 42119 se está desarrollando para cubrir diversos aspectos de las pruebas de sistemas basados en AI. Además, están surgiendo regulaciones sectoriales en áreas como la salud y las finanzas, reconociendo los riesgos únicos que plantea la AI en estos dominios.

Para navegar eficazmente este panorama en evolución de la gobernanza de la AI, el diálogo y la colaboración continuos son fundamentales. Los gobiernos, la industria, el ámbito académico y la sociedad civil deben participar activamente para lograr un enfoque armonizado y efectivo de la gobernanza de la AI a nivel mundial. Además, dada la naturaleza dinámica de la AI, las regulaciones y los estándares deben revisarse y actualizarse periódicamente para seguir siendo relevantes y efectivos en la orientación del desarrollo, despliegue y uso responsable de la AI.

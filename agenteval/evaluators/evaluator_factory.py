...
from agenteval.evaluators.model_config.preconfigured_model_configs import (
    ...
    DEFAULT_CLAUDE_HAIKU_4_5_MODEL_CONFIG,
    DEFAULT_CLAUDE_SONNET_4_5_MODEL_CONFIG,
)
...
_DEFAULT_MODEL_CONFIG_MAP = {
    ...
    "claude-haiku-4_5": DEFAULT_CLAUDE_HAIKU_4_5_MODEL_CONFIG,
    "claude-sonnet-4_5": DEFAULT_CLAUDE_SONNET_4_5_MODEL_CONFIG,
}
